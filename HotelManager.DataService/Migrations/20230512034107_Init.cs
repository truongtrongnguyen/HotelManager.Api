        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Allowvance = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    BankNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Salary = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DateContact = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ContactTerm = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
